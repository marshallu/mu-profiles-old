				...
				<div class="entry-content">
					<div class="flex flex-wrap lg:space-x-8">
						<div class="w-full lg:w-1/4">
							...
							<?php
							if ( get_field( 'employee_email_address' ) && 'both' === ( get_field( 'profile_show_email_address', 'option' ) || get_field( 'profile' === 'profile_show_email_address', 'option' ) ) ) {
								?>
									<div class="flex items-center my-4">
							...
							<?php } ?>
							<?php echo esc_url( get_field( 'employee_more_info_link' ) ); ?>
							<?php
							if ( get_field( 'employee_more_info_link' ) ) {
								...
								<div class="flex items-center my-4">
									...
									<a href="<?php echo esc_url( get_field( 'employee_more_info_link' ) ); ?>">More Info</a>
								</div>
							<?php } ?>
